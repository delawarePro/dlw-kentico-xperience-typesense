...
export const PathDetailTemplate = ({ aliasPath, columns }: PathDetailPageProps): JSX.Element => {
  ...
  return (
        <Stack spacing={Spacing.XL}>
            <Headline size={HeadlineSize.L}>{Localization.integrations.typesense.pathdetail.headlines.main}</Headline>
            <Box>
                <Headline size={HeadlineSize.S}>{Localization.integrations.typesense.pathdetail.headlines.path}</Headline>
                <span>{aliasPath}</span>
            </Box>
            <Box>
            <Headline size={HeadlineSize.S}>{Localization.integrations.typesense.pathdetail.headlines.pagetypes}</Headline>
            {tableData.totalCount > 0
              ...
              : (
                <p>{Localization.integrations.typesense.messages.norecords}</p>
                )}
            </Box>
