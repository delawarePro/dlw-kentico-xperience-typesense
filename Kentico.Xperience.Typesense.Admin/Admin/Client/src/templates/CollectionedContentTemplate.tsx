...
interface CollectionedContentPageProps {
...
export const CollectionedContentTemplate = ({ pathColumns, pathRows, propertyColumns, propertyRows }: CollectionedContentPageProps): JSX.Element => {
   usePageCommand<void, PathDetailArguments>(Commands.ShowPathDetail)

  return (
        <RoutingContentPlaceholder>
            <Stack spacing={Spacing.XXL}>
                <Headline size={HeadlineSize.M}>{Localization.integrations.typesense.content.headlines.main}</Headline>
                <Box>
                    <Headline size={HeadlineSize.S}>{Localization.integrations.typesense.content.headlines.paths}</Headline>
                </Box>
                <Box>
                    <Headline size={HeadlineSize.S}>{Localization.integrations.typesense.content.headlines.properties}</Headline>
