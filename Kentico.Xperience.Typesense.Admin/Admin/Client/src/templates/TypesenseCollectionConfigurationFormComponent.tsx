...
export interface TypesenseCollectionContentType {
...
export interface IncludedPath {
    ...
    contentTypes: TypesenseCollectionContentType[];
    identifier: string | null;
}

export interface TypesenseCollectionConfigurationComponentClientProperties
    extends FormComponentProps {
    value: IncludedPath[];
    possibleContentTypeItems: TypesenseCollectionContentType[] | null;
}
...
export const TypesenseCollectionConfigurationFormComponent = (
    props: TypesenseCollectionConfigurationComponentClientProperties,
): JSX.Element => {
    ...
    const savePath = (): void => {
        if (editedIdentifier === '') {
                ...
                if (path === '') {
                    ...
                    const newPath: IncludedPath = {
                        ...
                        contentTypes: contentTypesValue.map(x => {
                            const contentType: TypesenseCollectionContentType = {
            ...
            const updatedPath: IncludedPath = {
                aliasPath: path,
                identifier: props.value[propPathCollection].identifier,
                contentTypes: contentTypesValue.map(x => {
                    const contentType: TypesenseCollectionContentType = {
                        contentTypeDisplayName: x.label,
                        contentTypeName: x.value
            ...
            props.value[propPathCollection] = updatedPath;

            editedRow.cells[0] = pathCellInNewRow;
            editedRow.identifier = path;

            newRows[rowCollection] = editedRow;
            setRows(newRows);
        }
