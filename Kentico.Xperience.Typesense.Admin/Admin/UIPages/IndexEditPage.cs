...
internal class CollectionEditPage : BaseCollectionEditPage
{
    ...
    public CollectionEditPage(IFormItemCollectionProvider formItemCollectionProvider,
    ...
    protected override TypesenseConfigurationModel Model
    {
        get
        {
            model ??= StorageInKenticoService.GetCollectionDataOrNull(CollectionIdentifier) as TypesenseConfigurationModel ?? new();
