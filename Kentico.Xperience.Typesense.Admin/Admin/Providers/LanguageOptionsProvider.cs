...
internal class LanguageOptionsProvider : IGeneralSelectorDataProvider
{
    ...
    public async Task<PagedSelectListItems<string>> GetItemsAsync(string searchTerm, int pageCollection, CancellationToken cancellationToken)
    {
        ...
        itemQuery.Page(pageCollection, 20);
